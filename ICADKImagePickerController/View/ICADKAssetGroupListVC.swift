//
//  ICAICADKAssetGroupListVC.swift
...
class ICADKAssetGroupCell: UITableViewCell {
    
    class ICADKAssetGroupSeparator: UIView {
    ...
    var customSelectedBackgroundView: UIView = {
        ...
        let selectedFlag = UIImageView(image: ICADKImageResource.blueTickImage())
    ...
    lazy var customSeparator: ICADKAssetGroupSeparator = {
        let separator = ICADKAssetGroupSeparator(frame: CGRect(x: 10, y: self.bounds.height - 1, width: self.bounds.width, height: 0.5))
...
class ICAICADKAssetGroupListVC: UITableViewController, ICADKGroupDataManagerObserver {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(ICADKAssetGroupCell.self, forCellReuseIdentifier: DKImageGroupCellIdentifier)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: DKImageGroupCellIdentifier, for: indexPath) as! ICADKAssetGroupCell
		...
		if assetGroup.totalCount == 0 {
			cell.thumbnailImageView.image = ICADKImageResource.emptyAlbumIcon()
		} else {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ICADKPopoverViewController.dismissPopoverViewController()
