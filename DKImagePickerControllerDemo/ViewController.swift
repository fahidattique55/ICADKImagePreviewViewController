...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
	...
	func showImagePickerWithAssetType(_ assetType: ICADKImagePickerControllerAssetType,
	                                  allowMultipleType: Bool,
	                                  sourceType: ICADKImagePickerControllerSourceType = .both,
	                                  allowsLandscape: Bool,
	                                  singleSelect: Bool) {
		
		let pickerController = ICADKImagePickerController()
...
//		pickerController.defaultSelectedAssets = nil
		...
		pickerController.didSelectAssets = { [unowned self] (assets: [ICADKAsset]) in
    ...
    struct Demo {
        ...
        static let types: [ICADKImagePickerControllerAssetType] = [.allAssets, .allPhotos, .allVideos, .allAssets]
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let sourceType: ICADKImagePickerControllerSourceType = indexPath.section == 1 ? .camera :
