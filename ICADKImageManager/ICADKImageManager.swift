...
open class ICADKBaseManager: NSObject {
...
public func getImageManager() -> ICADKImageManager {
	return ICADKImageManager.sharedInstance
}

public class ICADKImageManager: ICADKBaseManager {
	...
	static let sharedInstance = ICADKImageManager()
    ...
    public lazy var groupDataManager: ICADKGroupDataManager! = {
        return ICADKGroupDataManager()
    }()
	...
	public func fetchImageForAsset(_ asset: ICADKAsset, size: CGSize, completeBlock: @escaping (_ image: UIImage?, _ info: [AnyHashable: Any]?) -> Void) {
		self.fetchImageForAsset(asset, size: size, options: nil, completeBlock: completeBlock)
	}
	
	public func fetchImageForAsset(_ asset: ICADKAsset, size: CGSize, contentMode: PHImageContentMode, completeBlock: @escaping (_ image: UIImage?, _ info: [AnyHashable: Any]?) -> Void) {
			self.fetchImageForAsset(asset, size: size, options: nil, contentMode: contentMode, completeBlock: completeBlock)
	}

	public func fetchImageForAsset(_ asset: ICADKAsset, size: CGSize, options: PHImageRequestOptions?, completeBlock: @escaping (_ image: UIImage?, _ info: [AnyHashable: Any]?) -> Void) {
		self.fetchImageForAsset(asset, size: size, options: options, contentMode: .aspectFill, completeBlock: completeBlock)
	}
	
	public func fetchImageForAsset(_ asset: ICADKAsset, size: CGSize, options: PHImageRequestOptions?, contentMode: PHImageContentMode,
	...
	public func fetchImageDataForAsset(_ asset: ICADKAsset, options: PHImageRequestOptions?, completeBlock: @escaping (_ data: Data?, _ info: [AnyHashable: Any]?) -> Void) {
	...
	public func fetchAVAsset(_ asset: ICADKAsset, completeBlock: @escaping (_ avAsset: AVAsset?, _ info: [AnyHashable: Any]?) -> Void) {
		self.fetchAVAsset(asset, options: nil, completeBlock: completeBlock)
	}
	
	public func fetchAVAsset(_ asset: ICADKAsset, options: PHVideoRequestOptions?, completeBlock: @escaping (_ avAsset: AVAsset?, _ info: [AnyHashable: Any]?) -> Void) {
