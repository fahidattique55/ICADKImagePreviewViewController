...
/**
 An `ICADKAsset` object represents a photo or a video managed by the `ICADKImagePickerController`.
 */
open class ICADKAsset: NSObject {
	...
	override open func isEqual(_ object: Any?) -> Bool {
        if let another = object as? ICADKAsset {
...
public extension ICADKAsset {
	
	struct ICADKAssetWriter {
		static let writeQueue: OperationQueue = {
			let queue = OperationQueue()
			queue.name = "ICADKAsset_Write_Queue"
